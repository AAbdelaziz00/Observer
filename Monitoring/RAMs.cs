...
namespace Obser
{
    class RAMs
    {
        protected internal string SetRamType()
        {
            int type = 0;
        ...
        private static string TypeString(int type)
        {
            ...
            switch (type)
            {
                ...
                case 0x11: outValue = "SDRAM - DDR4"; break;
